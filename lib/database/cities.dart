...
Map<String,LatLng> test =
    { "Ahmadpur East": LatLng(29.1459 , 71.2518)};
...
List getCityNames(){
     var city_names =new List();
   // Map<String,int> city_index ;
     for (int i=0; i< cities_latlng.length; i++){
         city_names.add(cities_latlng[i]['city']) ;
         //  print(cities_latlng[i]['city']);
         print(city_names[0]);
     }
return city_names;
}
